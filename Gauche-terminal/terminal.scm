...
(define (load-terminal-capability :key (term (sys-getenv "TERM")) fallback)
  (cond [(load-terminfo-entry :term term :fallback #f)]
        [(load-termcap-source :term term :fallback #f)]
